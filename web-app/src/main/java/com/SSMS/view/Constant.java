...
public class Constant {
    ...
    public static final String VIEW_CAREERS = "pages/careers";
    public static final String VIEW_PRICING = "pages/pricing";
    public static final String VIEW_PRIVACY_POLICY = "pages/privacypolicy";
    public static final String VIEW_SIGNUP = "pages/signup";
    public static final String VIEW_EARLY_ACCESS = "pages/early";
    public static final String VIEW_TERMS = "pages/terms";
